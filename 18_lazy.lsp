...
(take 10 *integers*)
(take-all (make-lazy '(q w e r t y u i o p a s d f g)))
...
(lazy-find-if (lambda (x) (eq x 12)) *integers*)
(lazy-find-if (lambda (x) (eq x 12)) (make-lazy '(q w e r t y u i o p a s d f g)))

(lazy-nth 10 *integers*)
